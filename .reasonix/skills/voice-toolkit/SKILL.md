---
name: voice-toolkit
description: 语音工具索引卡，汇总 MCP Server 地址、API 参数和优先级规则。当用户需要查询工具路径、API配置、调用方式时触发。
---
...
本技能包仅作为工具索引，汇总各 MCP Server 的路径、API 地址和调用方式。
**不包含工作流程**——有声书制作流程请用 `aubook-narration-producer` 技能包。
